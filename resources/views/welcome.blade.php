...
@section('content')
    ...
    <a href="" class="inline-block px-6 py-3 bg-gray-100  hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-opacity-50 transition duration-200">Newest Items</a>
    <a href="" class="inline-block px-6 py-3">My Items</a>
    <a href="">Add Items</a>
</div>
    <div class="mt-10">
